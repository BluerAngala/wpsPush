...
/*
    ...
    更新时间：20240112
    脚本：PUSH.js 推送脚本
    说明：此脚本为推送脚本。将PUSH加入定时任务即可定时进行推送。
          由于airscript 2.0未支持邮箱API，若需要邮箱服务请脚本类型请选择airscript 1.0
          服务授权记得添加“网络API”和“邮箱API”服务。
    具备功能：
            1. 多渠道推送
            2. 独立推送、消息池推送
            3. 消息过期判断
            ...
            7. 消息池内格式自动排版
    支持推送：
            bark、pushplus、Server酱（ServerChan）、邮箱（email）
            钉钉（dingtalk）、discord、企业微信（qywx
            息知（xizhi）、即时达（jishida）、wxpusher
*/
...
function bark(message, key) {
  ...
  BARK_ICON = "https://s21.ax1x.com/2025/01/12/pEPUqhD.jpg"
  let url = ""
